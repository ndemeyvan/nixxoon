package cm.studio.devbee.communitymarket.utilForT_shirt;
...
public class CategoriesAdapteTshirt extends RecyclerView.Adapter<CategoriesAdapteTshirt.ViewHolder> {
    ...
    public CategoriesAdapteTshirt(List<CategoriesModelTshirt> CategoriesModelTshirtList, Context context) {
        this.CategoriesModelTshirtList = CategoriesModelTshirtList;
    ...
    public void onBindViewHolder(@NonNull  final ViewHolder viewHolder, int i) {
        ...
        String desc =CategoriesModelTshirtList.get ( i).getDecription_du_produit();
        String nvxPrix=CategoriesModelTshirtList.get(i).getPrix_du_produit();
        String imageproduit=CategoriesModelTshirtList.get ( i ).getImage_du_produit ();
        final String nom_id=CategoriesModelTshirtList.get ( i ).getUtilisateur ();
        String tempsdepub=CategoriesModelTshirtList.get ( i ).getDate_de_publication ();
        String produinom=CategoriesModelTshirtList.get ( i ).getNom_du_produit ();
        final String postId=CategoriesModelTshirtList.get ( i ).PostId;
        final String current_user=firebaseAuth.getCurrentUser ().getUid ();
        final String idDuPost=CategoriesModelTshirtList.get ( i ).PostId;
    ...
    public int getItemCount() {
        return CategoriesModelTshirtList.size ();
    }
