package cm.studio.devbee.communitymarket.utilsForTshirt;
...
public class TshirtAdapter extends RecyclerView.Adapter<TshirtAdapter.ViewHolder> {
    List<TshitModel> TshitModelList;
    Context context;
    private FirebaseFirestore firebaseFirestore;
    private FirebaseAuth firebaseAuth;


    public TshirtAdapter(List<TshitModel> TshitModelList, Context context) {
        this.TshitModelList = TshitModelList;
    ...
    public void onBindViewHolder(@NonNull  final ViewHolder viewHolder, int i) {
        ...
        String desc =TshitModelList.get ( i).getDecription_du_produit();
        String nvxPrix=TshitModelList.get(i).getPrix_du_produit();
        String imageproduit=TshitModelList.get ( i ).getImage_du_produit ();
        final String nom_id=TshitModelList.get ( i ).getUtilisateur ();
        String tempsdepub=TshitModelList.get ( i ).getDate_de_publication ();
        String produinom=TshitModelList.get ( i ).getNom_du_produit ();
        final String postId=TshitModelList.get ( i ).PostId;
        final String current_user=firebaseAuth.getCurrentUser ().getUid ();
        final String idDuPost=TshitModelList.get ( i ).PostId;
